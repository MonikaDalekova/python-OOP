...
class BaseCampaign(ABC):
    ...
    def __init__(self, campaign_id: int, brand: str, budget: float, required_engagement: float):
        ...
        self.brand = brand
        self.budget = budget
        self.required_engagement = required_engagement #minimum engagement rate required for an influencer to be eligible for the campaign
        self.approved_influencers = [] #storing influencers objects for the campaign if they meet the eligibility criteria
